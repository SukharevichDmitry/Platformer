...
//        processInput();
//
//        if (grounded && hero.getState().equals(HeroState.JUMP)) {
...
//        hero.update(delta);
//
//        if (hero.getState().equals(HeroState.ATTACK)) {
...
//            if (!hero.getState().equals(HeroState.JUMP)) {
//                jumpingPressed = true;
//                jumpPressedTime = System.currentTimeMillis();
//                hero.setState(HeroState.JUMP);
...
//            hero.getAcceleration().x = ACCELERATION;
//        } else {
//            if (!hero.getState().equals(HeroState.JUMP) && !hero.getState().equals(HeroState.ATTACK)) {
//                hero.setState(HeroState.IDLE);
//            }
...
//            hero.setState(HeroState.ATTACK);
//            hero.setStateTime(0);
